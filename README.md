...
A personal portfolio website showcasing my profile, skills, projects, and contact information. It is designed using HTML, CSS, and JavaScript.

🔗Task 3 – Temperature Converter
A simple temperature converter that converts values between Celsius, Fahrenheit, and Kelvin using JavaScript with an easy-to-use interface.
